...
# archives.
#
# GENODE_DIR       - base directory of Genode
# DEPOT_DIR        - base directory of Genode's depot
...
$(ABI_DIR)/%.lib.so: $(ABI_DIR)/%.symbols.o
	$(CROSS_DEV_PREFIX)ld -o $@ -soname $(notdir $@) -shared --eh-frame-hdr $(LDFLAGS) \
	                      -T $(GENODE_DIR)/repos/base/src/ld/genode_rel.ld \
	                      $<
